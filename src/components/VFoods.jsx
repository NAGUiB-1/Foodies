...
export default function VFoods() {
  return (
    <div
      className="container mx-auto h-[560px] flex flex-col justify-center items-center gap-10 my-20 bg-no-repeat bg-cover bg-center "
    ...
    >
      ...
      <div className="flex bg-[#06C167] py-6 px-10 rounded text-white font-bold gap-2 cursor-pointer w-fit">
