...
export default function Features() {
  let cardStyle = `flex items-center flex-col justify-center md:flex-row  gap-3 p-3  w-[180px] md:w-[220px] `;
  let innerStyle = `flex flex-col justify-center items-center text-center md:text-center`;
  return (
